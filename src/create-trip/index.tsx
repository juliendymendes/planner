...
export function CreateTripPage() {
  ...
  return (
		<div className="h-screen flex items-center justify-center bg-pattern bg-no-repeat bg-center">
			...
			{
				isGuestsModalOpen && (
					<InviteGuestsModal addNewEmailToInvite={addNewEmailToInvite} closeGuestsModal={closeGuestsModal}
...

			{
				...
				createTrip={createTrip} setOwnerName={setOwnerName} setOwnerEmail={setOwnerEmail} />
			)
			}
		</div>
	)
