...
export function App() {
	...
	const [emailsToInvite, setEmailsToInvite] = useState(["juliendy@mail.com"])
			...
			<div className="max-w-3xl w-full px-6 text-center space-y-10">
				...
				<div className="space-y-4">
					<div className="h-16 gap-3 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape">
						...
						{isGuestsInputOpen ? <button onClick={closeGuestsInput} className="bg-zinc-800 text-zinc-200 rounded-lg px-5 py-2 font-medium flex items-center gap-2 hover:bg-zinc-700">
							Alterar local/data
				...
				isGuestsModalOpen && (
					<div className="fixed inset-0 flex items-center justify-center bg-black/60">
						<div className="w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
							...
							<form onSubmit={addNewEmailToInvite} className="p-2.5 bg-zinc-950 border flex items-center gap-2 border-zinc-800 rounded-lg">
